...
This repository is a **Functional Analyst–style** data profiling / data quality pack for a fintech-like dataset in **BigQuery**.
...
- **Phase 1 (this repo, now):** data profiling, validation rules, integrity checks, exception listing, evidence docs
- **Phase 2 (next):** RDT-style target schema + mapping rules + reconciliation controls (control totals, orphan checks, cross-table consistency)
